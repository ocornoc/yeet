...
begin
  ...
  cases b, { norm_num [of_digits] at h },
  cases b, { norm_num [of_digits] at h },
  have h2b : 2 < b + 4 := by linarith,
  have h3b : 3 < b + 4 := by linarith,
  rw digits_of_lt _ _ dec_trivial h2b at h,
  rw digits_of_lt _ _ dec_trivial h3b at h,
  change 9 = of_digits _ [3, 2] at h,
...
begin
  ...
  rw digits_of_lt _ _ dec_trivial h3b at h,
  rw digits_of_lt _ _ dec_trivial h4b at h,
  norm_num [of_digits] at h,
  apply_fun (% 4) at h,
  norm_num at h
end
